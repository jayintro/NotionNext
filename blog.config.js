...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'FuYuanzi', // 您的昵称 例如 FuYuanzi
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的技术型干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, FuYuanzi', // 网站关键词 英文逗号隔开
